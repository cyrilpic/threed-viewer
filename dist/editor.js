...
import './main.js';
import { create as create$f } from './docs/node_modules/filepond/dist/filepond.esm.js';
import { loader } from './dist/threed-viewer.esm.js';
import { Raycaster, Mesh, SphereBufferGeometry as SphereGeometry, MeshBasicMaterial, Vector2 } from './node_modules/three/build/three.module.js';
...
class Editor {
  constructor( container, viewer ) {
    ...
    // Prepare marker
    this.sphereInter = new Mesh( new SphereGeometry( 0.5 ), new MeshBasicMaterial( {color: 0x00ff00} ) );
    this.sphereInter.visible = false;
    this.viewer.scene.add( this.sphereInter );
    this.pointer = new Vector2( -5, -5 );
